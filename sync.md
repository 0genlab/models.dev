...
- The endpoint owns effort domains, including a domain containing every schema-supported level; the adapter does not infer support from the number of levels. Incorrect model claims must be corrected at the source.
